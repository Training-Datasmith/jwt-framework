...
#[As_Command(name: 'key:generate:okp', description: 'Generate an Octet Key Pair key (JWK format)')]
final class Okp_Key_Generator_Command extends Generator_Command
{
    #[Override]
    ...
    protected function execute(Input_Interface $input, Output_Interface $output): int
    {
        ...
        $jwk = Jwk_Factory::create_okp_key($curve, $args);
