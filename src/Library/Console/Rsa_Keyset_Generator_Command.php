...
#[As_Command(name: 'keyset:generate:rsa', description: 'Generate a key set with RSA keys (JWK format)')]
final class Rsa_Keyset_Generator_Command extends Generator_Command
{
    #[Override]
    ...
    protected function execute(Input_Interface $input, Output_Interface $output): int
    {
        ...
        for ($i = 0; $i < $quantity; ++$i) {
            ...
            $keyset = $keyset->with(Jwk_Factory::create_rsa_key($size, $args));
        }
