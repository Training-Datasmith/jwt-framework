...
final readonly class Key_Collector_Compiler_Pass implements Compiler_Pass_Interface
{
    #[Override]
    public function process(Container_Builder $container): void
    {
        if (!$container->has_definition(Key_Collector::class)) {
            return;
        }
        $definition = $container->get_definition(Key_Collector::class);
